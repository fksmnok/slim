...
/**
 * PH34 Sample14 マスタテーブル管理Slim版 Src09
 *
 * @author Shinzo SAITO
 *
 * ファイル名=LoginCheck.php
 * フォルダ=/ph34/sharereports/classes/middlewares/
 */

namespace LocalHalPH34\ShareReports\Classes\middlewares;

use Psr\Http\Message\ServerRequestInterface;
use Psr\Http\Message\ResponseInterface;
use Psr\Http\Server\RequestHandlerInterface;
use LocalHalPH34\ShareReports\Classes\exceptions\NoLoginException;
